...
# c.IPClusterStart.work_dir = u'/home/alexbw/.config/ipython'
...
# variable IPYTHONDIR.
# c.IPClusterStart.ipython_dir = u'/home/alexbw/.config/ipython'
...
# Set the working dir for the process.
# c.IPClusterEngines.work_dir = u'/home/alexbw/.config/ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPClusterEngines.ipython_dir = u'/home/alexbw/.config/ipython'
...
# The Logging format template
# c.IPClusterEngines.log_format = '[%(name)s] %(message)s'
...
# c.LocalControllerLauncher.controller_cmd = ['/scratch/global/alexbw/anaconda/bin/python', '-c', 'from IPython.parallel.apps.ipcontrollerapp import launch_new_instance; launch_new_instance()']
...
# c.LocalEngineLauncher.engine_cmd = ['/scratch/global/alexbw/anaconda/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
...
# command to launch the Engine.
# c.LocalEngineSetLauncher.engine_cmd = ['/scratch/global/alexbw/anaconda/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
...
# Popen command to launch ipcontroller.
# c.MPIControllerLauncher.controller_cmd = ['/scratch/global/alexbw/anaconda/bin/python', '-c', 'from IPython.parallel.apps.ipcontrollerapp import launch_new_instance; launch_new_instance()']
...
# command to launch the Engine.
# c.MPIEngineSetLauncher.engine_cmd = ['/scratch/global/alexbw/anaconda/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
...
# Popen command to launch ipcontroller.
# c.SSHControllerLauncher.controller_cmd = ['/scratch/global/alexbw/anaconda/bin/python', '-c', 'from IPython.parallel.apps.ipcontrollerapp import launch_new_instance; launch_new_instance()']
...
# command to launch the Engine.
# c.SSHEngineLauncher.engine_cmd = ['/scratch/global/alexbw/anaconda/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
...
# command to launch the Engine.
# c.SSHEngineSetLauncher.engine_cmd = ['/scratch/global/alexbw/anaconda/bin/python', '-c', 'from IPython.parallel.apps.ipengineapp import launch_new_instance; launch_new_instance()']
